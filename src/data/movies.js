export const moviesDatabase = [
  ...
  },
  {
    id: 9,
    title: "Titanic",
    description: "A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated ship.",
    hints: {
      genre: "Drama, Romance",
      year: 1997,
  ...
  },
  {
    ...
    hints: {
      ...
      dialogue: "Hakuna Matata! It means no worries."
    }
  },
  {
    id: 11,
  ...
  },
  {
    ...
    description: "A young Kansas girl and her dog are swept away by a tornado to a magical land where she embarks on a quest to see the Wizard who can help her return home.",
    hints: {
      genre: "Adventure, Family, Fantasy",
      year: 1939,
      actors: ["Judy Garland", "Frank Morgan"],
  ...
  },
  {
    id: 16,
    title: "Casablanca",
    description: "A cynical American expat struggles to decide whether or not he should help his former lover and her fugitive husband escape French Morocco.",
    hints: {
...
export const getRandomMovie = () => {
  ...
  return moviesDatabase[randomIndex]
}
